...
trainer.train(network=network, train_input=train_set_x, train_output=train_set_y,
              ...
              filename=['../models/styletransfer/conv_v_0/layer_0.npz', '../models/styletransfer/conv_v_0/bn_0.npz', None, None, # 1. Conv, BN, Activation, Pooling
                        '../models/styletransfer/conv_v_0/layer_1.npz', '../models/styletransfer/conv_v_0/bn_1.npz', None, None, # 2. Conv, BN, Activation, Pooling
                        '../models/styletransfer/conv_v_0/layer_2.npz', '../models/styletransfer/conv_v_0/bn_2.npz', None, None, # 3. Conv, BN, Activation, Pooling
                        None, '../models/styletransfer/conv_v_0/layer_3.npz', None, None])                                         # Reshape, Hiden, Activation

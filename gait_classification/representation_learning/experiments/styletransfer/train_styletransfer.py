...
network.load(['../models/cmu/sdAe_v_02/layer_0.npz', None, None, # 1. Conv, BN, Activation, Pooling
              '../models/cmu/sdAe_v_02/layer_1.npz', None, None, # 2. Conv, BN, Activation, Pooling
              '../models/cmu/sdAe_v_02/layer_2.npz', None, None, # 3. Conv, BN, Activation, Pooling 
              None, None, None])                             # Reshape, Hiden, Activation

trainer = AdamTrainer(rng=rng, batchsize=batchsize, epochs=30, alpha=0.0001, l1_weight=0.0, l2_weight=0.00001, cost='cross_entropy')
...
#              filename=['../models/styletransfer/conv_v_01/layer_0.npz', '../models/styletransfer/conv_v_01/bn_0.npz', None, None, # 1. Conv, BN, Activation, Pooling
#                        '../models/styletransfer/conv_v_01/layer_1.npz', '../models/styletransfer/conv_v_01/bn_1.npz', None, None, # 2. Conv, BN, Activation, Pooling
#                        '../models/styletransfer/conv_v_01/layer_2.npz', '../models/styletransfer/conv_v_01/bn_2.npz', None, None, # 3. Conv, BN, Activation, Pooling
#                        None, '../models/styletransfer/conv_v_01/layer_3.npz', None, None])                                         # Reshape, Hiden, Activation

...
for num_frame_pred in [10,25,28]:
	for frame in [1,2,5,8,10]:
		visualise(model, '256-256-256-fhl.hd5',orig_file="Joe/edin_shuffled.npz", frame=frame, num_frame_pred=num_frame_pred, num_pred_iter=0,\
		 anim_frame_start=((30-num_frame_pred)*8), anim_frame_end=232, test_start=310, control=True, control_type=None)
...
i = Dropout(0.2)(input_fcout) # Becuase there is no noise
...
for frame in [1,2,5,8,10]:
	visualise(model, '256x3-1FCNN.hd5',orig_file="Joe/edin_shuffled.npz", frame=frame, num_frame_pred=num_frame_pred, num_pred_iter=0,\

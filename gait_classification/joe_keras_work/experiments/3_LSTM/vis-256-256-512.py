...
num_frame_pred = 28
visualise(model, '3LSTMC-2x256-512.hd5',orig_file="Joe/edin_shuffled.npz", num_frame_pred=num_frame_pred, num_pred_iter=0,\
	 anim_frame_start=((30-num_frame_pred)*8), anim_frame_end=232, test_start=310, control=True,\
	 title="LSTM(256)-LSTM(256)-LSTM(512)-Dropout(0.2) Sample", filename="lstm256x2-512s")

...
def model(params):
    ...
    '''
    data = np.load('/home/masters/joe/deep-motion-analysis/gait_classification/data/Joe/sequential_final_frame.npz')
    ...
    model.compile(loss='mean_squared_error', optimizer=keras.optimizers.Nadam(lr=lr, beta_1=0.9, beta_2=0.999, epsilon=1e-08, schedule_decay=0.004))

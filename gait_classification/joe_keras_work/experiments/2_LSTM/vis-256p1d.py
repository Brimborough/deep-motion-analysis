...
visualise(model, '2LSTM-256-fp1-d.hd5',orig_file="Joe/edin_shuffled.npz", frame=10, num_frame_pred=20, num_pred_iter=0, anim_frame_end=240, test_start=310, control=True)
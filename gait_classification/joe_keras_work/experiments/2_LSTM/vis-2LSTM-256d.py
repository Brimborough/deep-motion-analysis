...
from visualise_before_img import visualise
...
visualise(model, '2LSTM-256d-0.1.hd5',orig_file="Joe/edin_shuffled.npz",frame=10, num_frame_pred=24, num_pred_iter=1, anim_frame_end=224, test_start=310)

...
x = TimeDistributed(Dense(3))(inp2)
...
visualise(model, '1LSTM-256-fp1afterLSTM.hd5',orig_file="Joe/edin_shuffled.npz", frame=10, num_frame_pred=25, num_pred_iter=0, anim_frame_end=240, test_start=310, control=True)
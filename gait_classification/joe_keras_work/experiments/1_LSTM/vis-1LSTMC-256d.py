...
for frame in [1,2,5,8,10]:
	visualise(model, '1LSTMC-256d.hd5',orig_file="Joe/edin_shuffled.npz", frame=frame, num_frame_pred=num_frame_pred, num_pred_iter=0, anim_frame_start=((30-num_frame_pred)*8), test_start=310, control=True)
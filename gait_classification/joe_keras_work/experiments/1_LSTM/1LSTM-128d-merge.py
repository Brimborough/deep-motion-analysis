...
data = np.load('../../../data/merged_loco/sequential_final_frame_edin_hdm05.npz')
...
X = np.load('../../../data/merged_loco/edin_hdm05_shuffled.npz')['clips']

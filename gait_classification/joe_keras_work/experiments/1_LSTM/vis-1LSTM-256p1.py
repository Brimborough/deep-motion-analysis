...
visualise(model, '1LSTM-256-fp1.hd5',orig_file="Joe/edin_shuffled.npz", frame=4, num_frame_pred=20, num_pred_iter=0, anim_frame_end=240, test_start=310, control=True)
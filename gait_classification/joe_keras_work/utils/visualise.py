...
def visualise(model, weight_file, frame=0 , num_frame_pred=1, anim_frame_start=0, anim_frame_end=240, num_pred_iter=10,\
        orig_file='Joe/edin_shuffled.npz', pre_lstm='Joe/pre_proc_lstm.npz', extracted='Joe/sequential_final_frame.npz' ,test_start=310, filename=None):
    ...
    animation_plot([Xorig, Xrecn, Xpred], filename=filename,interval=15.15, labels=['Root','Reconstruction', 'Predicted'])

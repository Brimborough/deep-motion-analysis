...
class split_data:
    ...
    def split(self, filename, step, serieslength):
        ...
        '''
        np.savez_compressed('../data/Joe/distributed_data', train_x=train_x_dis, train_y=train_y_dis, test_x=test_x_dis, test_y=test_y_dis)
        np.savez_compressed('../data/Joe/none_distributed_data', train_x=train_x, train_y=train_y, test_x=test_x,
                            test_y=test_y)
